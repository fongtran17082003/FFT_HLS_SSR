...
namespace fft_4k_ssr2_i16_c16_t16
{
...
extern "C"
{
  void fft_4k_ssr2_i16_c16_t16_top( ap_int<4*fft_4k_ssr2_i16_c16_t16::input_width> *din,
                            ap_int<4*fft_4k_ssr2_i16_c16_t16::internal_width> *dout,
                            int iter )
  {
    const int sim_depth = fft_4k_ssr2_i16_c16_t16::FFT_ITER * fft_4k_ssr2_i16_c16_t16::FFT_SIZE / 2;
#pragma HLS INTERFACE mode=s_axilite port=iter
#pragma HLS INTERFACE mode=s_axilite port=return
#pragma HLS INTERFACE mode=m_axi port=dout bundle=gmem2 depth=sim_depth max_widen_bitwidth=512 offset=slave
#pragma HLS INTERFACE mode=m_axi port=din  bundle=gmem1 depth=sim_depth max_widen_bitwidth=512 offset=slave

    fft_4k_ssr2_i16_c16_t16::fft_core(din, dout, iter);
  }
}
