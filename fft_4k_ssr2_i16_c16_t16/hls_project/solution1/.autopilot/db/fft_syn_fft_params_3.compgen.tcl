...
# === IP Block fft_syn<fft_params>.3 ===
set id 79
set name fft_4k_ssr2_i16_c16_t16_top_fft_syn_fft_params_3
set cppname "fft_syn<fft_params>.3"
...
set ipParamList { \
    ...
    number_of_stages_using_block_ram_for_data_and_phase_factors {2} \
    output_ordering {1} \
    output_width {16} \
    ovflo {1} \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ${name} BINDTYPE op TYPE ip_block_$corename
}
...
# === end of IP Block fft_syn<fft_params>.3 ===
