...
entity fft_4k_ssr2_i16_c16_t16_top_fft_syn_fft_params_s is
    generic (
...
architecture arch of fft_4k_ssr2_i16_c16_t16_top_fft_syn_fft_params_s is
    --------------------- Component ---------------------
    component fft_4k_ssr2_i16_c16_t16_top_fft_syn_fft_params_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fft_4k_ssr2_i16_c16_t16_top_fft_syn_fft_params_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
