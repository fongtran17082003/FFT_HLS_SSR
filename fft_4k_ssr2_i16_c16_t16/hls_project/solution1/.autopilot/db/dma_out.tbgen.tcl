...
set C_modelArgMapList {[ 
	{ "Name" : "joiner_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "iter", "interface" : "fifo", "bitwidth" : 20, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ iter_dout sc_in sc_lv 20 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "iter_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "iter", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "73", "Max" : "4170"}
	, {"Name" : "Interval", "Min" : "73", "Max" : "4170"}
]}
...
set Spec2ImplPortList { 
	...
	iter { ap_fifo {  { iter_dout fifo_data_in 0 20 }  { iter_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_fifo_cap fifo_update 0 3 }  { iter_empty_n fifo_status 0 1 }  { iter_read fifo_port_we 1 1 } } }
}
