...
set portList { 
	...
	{ iter_dout sc_in sc_lv 32 signal 1 } 
	{ iter_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ iter_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ iter_empty_n sc_in sc_logic 1 signal 1 } 
	{ iter_read sc_out sc_logic 1 signal 1 } 
	{ iter_c20_din sc_out sc_lv 32 signal 2 } 
	{ iter_c20_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ iter_c20_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ iter_c20_full_n sc_in sc_logic 1 signal 2 } 
	{ iter_c20_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "iter_c20_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "iter_c20", "role": "num_data_valid" }} , 
 	{ "name": "iter_c20_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "iter_c20", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	iter_c20 { ap_fifo {  { iter_c20_din fifo_data_in 1 32 }  { iter_c20_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_c20_fifo_cap fifo_update 0 3 }  { iter_c20_full_n fifo_status 0 1 }  { iter_c20_write fifo_port_we 1 1 } } }
}
