set moduleName joiner_Pipeline_VITIS_LOOP_285_1_VITIS_LOOP_288_2
set isTopModule 0
...
set C_modelName {joiner_Pipeline_VITIS_LOOP_285_1_VITIS_LOOP_288_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ bound int 43 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 43, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fft2_out0_dout sc_in sc_lv 32 signal 1 } 
	{ fft2_out0_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ fft2_out0_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ fft2_out0_empty_n sc_in sc_logic 1 signal 1 } 
	{ fft2_out0_read sc_out sc_logic 1 signal 1 } 
	{ fft2_out1_dout sc_in sc_lv 32 signal 2 } 
	{ fft2_out1_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ fft2_out1_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ fft2_out1_empty_n sc_in sc_logic 1 signal 2 } 
	{ fft2_out1_read sc_out sc_logic 1 signal 2 } 
	{ joiner_out_din sc_out sc_lv 64 signal 3 } 
	{ joiner_out_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ joiner_out_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ joiner_out_full_n sc_in sc_logic 1 signal 3 } 
	{ joiner_out_write sc_out sc_logic 1 signal 3 } 
	{ bound sc_in sc_lv 43 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bound", "direction": "in", "datatype": "sc_lv", "bitwidth":43, "type": "signal", "bundle":{"name": "bound", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	bound { ap_none {  { bound in_data 0 43 } } }
