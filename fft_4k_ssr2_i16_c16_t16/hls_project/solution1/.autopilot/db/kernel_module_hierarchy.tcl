set ModuleHierarchy {[{
"Name" : "fft_4k_ssr2_i16_c16_t16_top","ID" : "0","Type" : "sequential",
"SubInsts" : [
	{"Name" : "grp_fft_core_fu_78","ID" : "1","Type" : "dataflow",
		...
		{"Name" : "reorder_U0","ID" : "5","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_reorder_Pipeline_pipeup_l1_pipeup_l2_fu_392","ID" : "6","Type" : "sequential",
				"SubLoops" : [
		...
		{"Name" : "twiddle_U0","ID" : "12","Type" : "sequential",
			...
			{"Name" : "grp_twiddle_Pipeline_VITIS_LOOP_264_1_VITIS_LOOP_267_2_fu_96","ID" : "13","Type" : "sequential",
				...
				"SubInsts" : [
				{"Name" : "grp_get_phase_factor_fu_106","ID" : "15","Type" : "pipeline"},]},]},]},
		...
		{"Name" : "fft_serial_kernel_wrapper_U0","ID" : "26","Type" : "dataflow",
			...
			{"Name" : "fft_serial_kernel_U0","ID" : "28","Type" : "sequential",
				...
				"SubInsts" : [
				{"Name" : "dataflow_in_loop_VITIS_LOOP_310_1_130_U0","ID" : "30","Type" : "dataflow",
						"SubInsts" : [
