...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_iter_c25 \
    op interface \
    ports { iter_c25_din { O 32 vector } iter_c25_num_data_valid { I 3 vector } iter_c25_fifo_cap { I 3 vector } iter_c25_full_n { I 1 bit } iter_c25_write { O 1 bit } } \
} "
}
