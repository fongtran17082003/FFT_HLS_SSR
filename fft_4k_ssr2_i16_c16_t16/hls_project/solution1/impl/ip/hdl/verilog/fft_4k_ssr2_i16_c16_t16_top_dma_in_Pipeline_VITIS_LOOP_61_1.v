...
module fft_4k_ssr2_i16_c16_t16_top_dma_in_Pipeline_VITIS_LOOP_61_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] temp_in_reg_141;
reg   [29:0] i_fu_58;
wire   [29:0] add_ln61_fu_108_p2;
wire    ap_loop_init;
reg   [29:0] ap_sig_allocacmp_i_load;
reg    ap_block_pp0_stage0_01001;
wire   [30:0] zext_ln61_fu_98_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln61_fu_102_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln61_fu_102_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln61_fu_108_p2 = (ap_sig_allocacmp_i_load + 30'd1);
...
assign icmp_ln61_fu_102_p2 = (($signed(zext_ln61_fu_98_p1) < $signed(tmp_4)) ? 1'b1 : 1'b0);

assign input_stream_din = temp_in_reg_141;
...
assign zext_ln61_fu_98_p1 = ap_sig_allocacmp_i_load;

endmodule //fft_4k_ssr2_i16_c16_t16_top_dma_in_Pipeline_VITIS_LOOP_61_1
