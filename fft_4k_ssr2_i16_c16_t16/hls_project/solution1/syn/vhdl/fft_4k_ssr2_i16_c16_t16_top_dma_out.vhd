...
entity fft_4k_ssr2_i16_c16_t16_top_dma_out is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_4k_ssr2_i16_c16_t16_top_dma_out is 
...
attribute shreg_extract : string;
    ...
    signal iter_5_reg_171 : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal trunc_ln90_fu_113_p1 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    component fft_4k_ssr2_i16_c16_t16_top_dma_out_Pipeline_VITIS_LOOP_90_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103 : component fft_4k_ssr2_i16_c16_t16_top_dma_out_Pipeline_VITIS_LOOP_90_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                    empty_reg_182(29 downto 11) <= empty_fu_141_p3(29 downto 11);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                    tmp_reg_192(30 downto 11) <= tmp_fu_163_p3(30 downto 11);
            end if;
        end if;
    end process;
    empty_reg_182(10 downto 0) <= "00000000000";
    tmp_reg_192(10 downto 0) <= "00000000000";
    ...
    icmp_ln90_fu_125_p2 <= "1" when (signed(iter_dout) > signed(ap_const_lv20_0)) else "0";
    ...
    tmp_fu_163_p3 <= (iter_5_reg_171 & ap_const_lv11_0);
    trunc_ln90_fu_113_p1 <= iter_dout(19 - 1 downto 0);
    trunc_ln_fu_117_p3 <= (trunc_ln90_fu_113_p1 & ap_const_lv11_0);
