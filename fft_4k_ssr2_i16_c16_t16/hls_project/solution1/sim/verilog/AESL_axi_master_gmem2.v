...
//------------------------Parameter----------------------
`define TV_IN_gmem2 "../tv/cdatafile/c.fft_4k_ssr2_i16_c16_t16_top.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.fft_4k_ssr2_i16_c16_t16_top.autotvout_gmem2.dat"
 parameter gmem2_ADDR_BITWIDTH = 32'd 64;
 parameter gmem2_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem2_DATA_BITWIDTH = 32'd 64;
...
parameter gmem2_C_DATA_BITWIDTH = 32'd 64;
parameter gmem2_transaction_depth = 32'd 4096;
parameter gmem2_mem_depth = 32'd 4096;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/phongtran/Downloads/ssr-fft-main/fft_4k_ssr2_i16_c16_t16/hls_project/solution1/sim/verilog/AESL_axi_master_gmem2.v: Write request address %d exceed AXI master gmem2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/phongtran/Downloads/ssr-fft-main/fft_4k_ssr2_i16_c16_t16/hls_project/solution1/sim/verilog/AESL_axi_master_gmem2.v: Read request address %d exceed AXI master gmem2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
