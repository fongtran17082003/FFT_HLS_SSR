...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fft_4k_ssr2_i16_c16_t16_top.autotvin_gmem1.dat"
         "c.fft_4k_ssr2_i16_c16_t16_top.autotvin_din.dat"
         "c.fft_4k_ssr2_i16_c16_t16_top.autotvin_dout.dat"
         "c.fft_4k_ssr2_i16_c16_t16_top.autotvin_iter.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fft_4k_ssr2_i16_c16_t16_top.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
