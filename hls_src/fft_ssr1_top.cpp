...
extern "C"
{
  void fft_placeholder_top( ap_int<2*fft_placeholder::input_width> *din,
                            ap_int<2*fft_placeholder::internal_width> *dout,
                            int iter )
  {
    const int sim_depth = fft_placeholder::FFT_ITER * fft_placeholder::FFT_SIZE;
