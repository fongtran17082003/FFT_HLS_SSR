...
set portList { 
	...
	{ iter_c_din sc_out sc_lv 28 signal 2 } 
	{ iter_c_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ iter_c_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ iter_c_full_n sc_in sc_logic 1 signal 2 } 
	{ iter_c_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	iter_c { ap_fifo {  { iter_c_din fifo_data_in 1 28 }  { iter_c_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_c_fifo_cap fifo_update 0 3 }  { iter_c_full_n fifo_status 0 1 }  { iter_c_write fifo_port_we 1 1 } } }
}
