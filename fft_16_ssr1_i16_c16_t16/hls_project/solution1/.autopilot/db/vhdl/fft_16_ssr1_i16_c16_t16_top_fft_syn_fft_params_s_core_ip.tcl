create_ip -vlnv xilinx.com:ip:xfft -module_name fft_16_ssr1_i16_c16_t16_top_fft_syn_fft_params_s_core_ip
set_property -dict [list \
    ...
    CONFIG.target_clock_frequency {334} \
    CONFIG.throttle_scheme {nonrealtime} \
    CONFIG.transform_length {16} \
    CONFIG.xk_index {0} \
] -objects [get_ips fft_16_ssr1_i16_c16_t16_top_fft_syn_fft_params_s_core_ip]
set_property generate_synth_checkpoint false [get_files fft_16_ssr1_i16_c16_t16_top_fft_syn_fft_params_s_core_ip.xci]
generate_target {synthesis simulation} [get_files fft_16_ssr1_i16_c16_t16_top_fft_syn_fft_params_s_core_ip.xci]
