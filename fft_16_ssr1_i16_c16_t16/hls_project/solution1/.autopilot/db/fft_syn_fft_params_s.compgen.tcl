...
# === IP Block fft_syn<fft_params> ===
set id 18
set name fft_16_ssr1_i16_c16_t16_top_fft_syn_fft_params_s
set cppname "fft_syn<fft_params>"
...
set ipParamList { \
    ...
    number_of_stages_using_block_ram_for_data_and_phase_factors {0} \
    output_ordering {1} \
    output_width {16} \
    ovflo {1} \
...
# === end of IP Block fft_syn<fft_params> ===
