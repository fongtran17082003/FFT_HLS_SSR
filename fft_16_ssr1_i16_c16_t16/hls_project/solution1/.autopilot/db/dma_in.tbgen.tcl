...
set C_modelName {dma_in}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 512 regular {axi_master 0}  }
	{ din int 64 regular  }
	{ input_stream int 32 regular {fifo 1 volatile }  }
	{ iter int 32 regular  }
	{ iter_c10 int 32 regular {fifo 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "din","offset": { "type": "dynamic","port_name": "din","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "din", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "input_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "iter", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "iter_c10", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_stream_din sc_out sc_lv 32 signal 2 } 
	{ input_stream_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ input_stream_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ input_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ input_stream_write sc_out sc_logic 1 signal 2 } 
	{ iter sc_in sc_lv 32 signal 3 } 
	{ iter_c10_din sc_out sc_lv 32 signal 4 } 
	{ iter_c10_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ iter_c10_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ iter_c10_full_n sc_in sc_logic 1 signal 4 } 
	{ iter_c10_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "input_stream", "role": "din" }} , 
 	...
 	{ "name": "iter_c10_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "iter_c10", "role": "din" }} , 
 	{ "name": "iter_c10_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "iter_c10", "role": "num_data_valid" }} , 
 	{ "name": "iter_c10_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "iter_c10", "role": "fifo_cap" }} , 
 	{ "name": "iter_c10_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "iter_c10", "role": "full_n" }} , 
 	{ "name": "iter_c10_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "iter_c10", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "75", "EstimateLatencyMax" : "588",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dma_in_Pipeline_VITIS_LOOP_53_1_fu_98", "Port" : "gmem1", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
			{"Name" : "din", "Type" : "None", "Direction" : "I"},
			{"Name" : "input_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0","0","0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dma_in_Pipeline_VITIS_LOOP_53_1_fu_98", "Port" : "input_stream", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
			{"Name" : "iter", "Type" : "None", "Direction" : "I"},
			{"Name" : "iter_c10", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "iter_c10_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dma_in_Pipeline_VITIS_LOOP_53_1_fu_98", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "dma_in_Pipeline_VITIS_LOOP_53_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2", "EstimateLatencyMax" : "515",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dma_in_Pipeline_VITIS_LOOP_53_1_fu_98.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	dma_in {
		...
		iter_c10 {Type O LastRead -1 FirstWrite 0}}
	dma_in_Pipeline_VITIS_LOOP_53_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "75", "Max" : "588"}
	, {"Name" : "Interval", "Min" : "75", "Max" : "588"}
]}
...
set Spec2ImplPortList { 
	...
	input_stream { ap_fifo {  { input_stream_din fifo_data_in 1 32 }  { input_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { input_stream_fifo_cap fifo_update 0 3 }  { input_stream_full_n fifo_status 0 1 }  { input_stream_write fifo_port_we 1 1 } } }
	iter { ap_none {  { iter in_data 0 32 } } }
	iter_c10 { ap_fifo {  { iter_c10_din fifo_data_in 1 32 }  { iter_c10_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_c10_fifo_cap fifo_update 0 3 }  { iter_c10_full_n fifo_status 0 1 }  { iter_c10_write fifo_port_we 1 1 } } }
}
