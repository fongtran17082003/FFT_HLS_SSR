...
set C_modelName {dma_out}
set C_modelType { void 0 }
set C_modelArgList {
	{ fft_out int 32 regular {fifo 0 volatile }  }
	{ gmem2 int 512 regular {axi_master 1}  }
	{ dout int 64 regular {fifo 0}  }
	{ iter int 28 regular {fifo 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "fft_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "dout","offset": { "type": "dynamic","port_name": "dout","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "dout", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "iter", "interface" : "fifo", "bitwidth" : 28, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ fft_out_dout sc_in sc_lv 32 signal 0 } 
	{ fft_out_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ fft_out_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ fft_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ fft_out_read sc_out sc_logic 1 signal 0 } 
	...
	{ iter_dout sc_in sc_lv 28 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fft_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fft_out", "role": "dout" }} , 
 	{ "name": "fft_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "fft_out", "role": "num_data_valid" }} , 
 	{ "name": "fft_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "fft_out", "role": "fifo_cap" }} , 
 	{ "name": "fft_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fft_out", "role": "empty_n" }} , 
 	{ "name": "fft_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fft_out", "role": "read" }} , 
 	...
 	{ "name": "iter_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "iter", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "74", "EstimateLatencyMax" : "587",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "fft_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1","-1","-1","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dma_out_Pipeline_VITIS_LOOP_78_1_fu_101", "Port" : "fft_out", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dma_out_Pipeline_VITIS_LOOP_78_1_fu_101", "Port" : "gmem2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dma_out_Pipeline_VITIS_LOOP_78_1_fu_101", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "dma_out_Pipeline_VITIS_LOOP_78_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "fft_out", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fft_out_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_78_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter2", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dma_out_Pipeline_VITIS_LOOP_78_1_fu_101.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}


set ArgLastReadFirstWriteLatency {
	dma_out {
		fft_out {Type I LastRead 1 FirstWrite -1}
		gmem2 {Type O LastRead 5 FirstWrite 2}
		dout {Type I LastRead 0 FirstWrite -1}
		iter {Type I LastRead 0 FirstWrite -1}}
	dma_out_Pipeline_VITIS_LOOP_78_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "74", "Max" : "587"}
	, {"Name" : "Interval", "Min" : "74", "Max" : "587"}
]}
...
set Spec2ImplPortList { 
	fft_out { ap_fifo {  { fft_out_dout fifo_data_in 0 32 }  { fft_out_num_data_valid fifo_status_num_data_valid 0 3 }  { fft_out_fifo_cap fifo_update 0 3 }  { fft_out_empty_n fifo_status 0 1 }  { fft_out_read fifo_port_we 1 1 } } }
	...
	iter { ap_fifo {  { iter_dout fifo_data_in 0 28 }  { iter_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_fifo_cap fifo_update 0 3 }  { iter_empty_n fifo_status 0 1 }  { iter_read fifo_port_we 1 1 } } }
}
