...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln78 \
    op interface \
    ports { sext_ln78 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_fft_out \
    op interface \
    ports { fft_out_dout { I 32 vector } fft_out_num_data_valid { I 3 vector } fft_out_fifo_cap { I 3 vector } fft_out_empty_n { I 1 bit } fft_out_read { O 1 bit } } \
} "
}
...
set InstName fft_16_ssr1_i16_c16_t16_top_flow_control_loop_pipe_sequential_init_U
set CompName fft_16_ssr1_i16_c16_t16_top_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix fft_16_ssr1_i16_c16_t16_top_ \
}"
} else {
