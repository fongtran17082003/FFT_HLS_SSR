...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_iter_c10 \
    op interface \
    ports { iter_c10_din { O 32 vector } iter_c10_num_data_valid { I 3 vector } iter_c10_fifo_cap { I 3 vector } iter_c10_full_n { I 1 bit } iter_c10_write { O 1 bit } } \
} "
}
