set moduleName fft_syn_fft_params_s
set isTopModule 0
...
set C_modelName {fft_syn<fft_params>}
set C_modelType { void 0 }
set C_modelArgList {
	{ xn int 32 regular {fifo 0 volatile }  }
	{ xk int 32 regular {fifo 1 volatile }  }
	{ status_data_V int 8 regular {fifo 1 volatile }  }
	{ config_ch_data_V int 8 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "xn", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "config_ch_data_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ config_ch_data_V_dout sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "config_ch_data_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "config_ch_data_V", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	xn { ap_fifo {  { xn_dout fifo_data_in 0 32 }  { xn_empty_n fifo_status 0 1 }  { xn_read fifo_port_we 1 1 } } }
	xk { ap_fifo {  { xk_din fifo_data_in 1 32 }  { xk_full_n fifo_status 0 1 }  { xk_write fifo_port_we 1 1 } } }
	status_data_V { ap_fifo {  { status_data_V_din fifo_data_in 1 8 }  { status_data_V_full_n fifo_status 0 1 }  { status_data_V_write fifo_port_we 1 1 } } }
	config_ch_data_V { ap_fifo {  { config_ch_data_V_dout fifo_data_in 0 8 }  { config_ch_data_V_empty_n fifo_status 0 1 }  { config_ch_data_V_read fifo_port_we 1 1 } } }
}
