...
$(ObjDir)/fft_model.cpp_pre.cpp.tb.o : fft_model.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fft_model.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fft_16_ssr1_i16_c16_t16.cpp_pre.cpp.tb.o : fft_16_ssr1_i16_c16_t16.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fft_16_ssr1_i16_c16_t16.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
