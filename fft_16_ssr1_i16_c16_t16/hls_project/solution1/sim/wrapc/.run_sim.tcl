...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/phongtran/Downloads/VIVADO/Vitis_HLS/2023.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/phongtran/Downloads/VIVADO/Vitis_HLS/2023.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/phongtran/Downloads/VIVADO/Vitis_HLS/2023.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/phongtran/Downloads/VIVADO/Vitis_HLS/2023.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/phongtran/Downloads/VIVADO/Vitis_HLS/2023.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fft_16_ssr1_i16_c16_t16_top.autotvin.dat"
	set constFileTvOut       "fft_16_ssr1_i16_c16_t16_top.autotvout.dat"
	set constFileHdlTvIn     "fft_16_ssr1_i16_c16_t16_top.autohdltvin.dat"
	set constFileHdlTvOut    "fft_16_ssr1_i16_c16_t16_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
