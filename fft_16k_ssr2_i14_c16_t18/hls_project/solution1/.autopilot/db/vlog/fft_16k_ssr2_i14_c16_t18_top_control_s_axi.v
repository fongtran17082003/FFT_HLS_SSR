...
// ==============================================================
`timescale 1ns/1ps
module fft_16k_ssr2_i14_c16_t18_top_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_DIN_DATA_1  = 6'h14,
    ADDR_DIN_CTRL    = 6'h18,
    ADDR_DOUT_DATA_0 = 6'h1c,
    ADDR_DOUT_DATA_1 = 6'h20,
    ADDR_DOUT_CTRL   = 6'h24,
    ADDR_ITER_DATA_0 = 6'h28,
    ADDR_ITER_CTRL   = 6'h2c,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_DIN_DATA_1)
            int_din[63:32] <= (WDATA[31:0] & wmask) | (int_din[63:32] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ITER_DATA_0)
            int_iter[31:0] <= (WDATA[31:0] & wmask) | (int_iter[31:0] & ~wmask);
    end
end
