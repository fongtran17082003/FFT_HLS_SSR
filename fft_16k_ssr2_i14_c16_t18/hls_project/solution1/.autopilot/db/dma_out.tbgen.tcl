...
set C_modelArgList {
	{ joiner_out int 64 regular {fifo 0 volatile }  }
	{ gmem2 int 64 regular {axi_master 1}  }
	{ dout int 64 regular {fifo 0}  }
	{ iter int 18 regular {fifo 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "joiner_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "iter", "interface" : "fifo", "bitwidth" : 18, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ joiner_out_dout sc_in sc_lv 64 signal 0 } 
	{ joiner_out_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ joiner_out_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ joiner_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ joiner_out_read sc_out sc_logic 1 signal 0 } 
	...
	{ dout_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ dout_fifo_cap sc_in sc_lv 4 signal 2 } 
	{ dout_empty_n sc_in sc_logic 1 signal 2 } 
	{ dout_read sc_out sc_logic 1 signal 2 } 
	{ iter_dout sc_in sc_lv 18 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "joiner_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "joiner_out", "role": "dout" }} , 
 	...
 	{ "name": "joiner_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "joiner_out", "role": "empty_n" }} , 
 	{ "name": "joiner_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "joiner_out", "role": "read" }} , 
 	...
 	{ "name": "dout_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "dout", "role": "num_data_valid" }} , 
 	{ "name": "dout_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "dout", "role": "fifo_cap" }} , 
 	...
 	{ "name": "iter_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "iter", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "joiner_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103", "Port" : "joiner_out", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "dout", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "73", "Max" : "8266"}
	, {"Name" : "Interval", "Min" : "73", "Max" : "8266"}
]}
...
set Spec2ImplPortList { 
	joiner_out { ap_fifo {  { joiner_out_dout fifo_data_in 0 64 }  { joiner_out_num_data_valid fifo_status_num_data_valid 0 3 }  { joiner_out_fifo_cap fifo_update 0 3 }  { joiner_out_empty_n fifo_status 0 1 }  { joiner_out_read fifo_port_we 1 1 } } }
	...
	dout { ap_fifo {  { dout_dout fifo_data_in 0 64 }  { dout_num_data_valid fifo_status_num_data_valid 0 4 }  { dout_fifo_cap fifo_update 0 4 }  { dout_empty_n fifo_status 0 1 }  { dout_read fifo_port_we 1 1 } } }
	iter { ap_fifo {  { iter_dout fifo_data_in 0 18 }  { iter_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_fifo_cap fifo_update 0 3 }  { iter_empty_n fifo_status 0 1 }  { iter_read fifo_port_we 1 1 } } }
}
