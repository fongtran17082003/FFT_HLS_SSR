set moduleName dataflow_in_loop_VITIS_LOOP_310_1_133
set isTopModule 0
...
set C_modelName {dataflow_in_loop_VITIS_LOOP_310_1.133}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "5", "6", "7", "8", "9"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "Block_newFuncRoot_proc_proc17_U0"}],
		"OutputProcess" : [
			{"ID" : "3", "Name" : "fft_fft_params_U0"},
			{"ID" : "5", "Name" : "Block_newFuncRoot_proc_proc19_U0"}],
		"Port" : [
			{"Name" : "twiddle_out1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "fft_fft_params_U0", "Port" : "twiddle_out1"}]},
			{"Name" : "fft2_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "fft_fft_params_U0", "Port" : "fft2_out1"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_newFuncRoot_proc_proc17_U0", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_newFuncRoot_proc_proc18_U0", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fft_fft_params_U0", "Parent" : "0", "Child" : ["4"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "4", "Name" : "fft_syn_fft_params_3_U0"}],
		"OutputProcess" : [
			{"ID" : "4", "Name" : "fft_syn_fft_params_3_U0"}],
		"Port" : [
			{"Name" : "twiddle_out1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "fft_syn_fft_params_3_U0", "Port" : "xn"}]},
			{"Name" : "fft2_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "fft_syn_fft_params_3_U0", "Port" : "xk"}]},
			{"Name" : "fft_status", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["5"], "DependentChan" : "8", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "fft_syn_fft_params_3_U0", "Port" : "status_data_V"}]},
			{"Name" : "fft_config", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "7", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "fft_syn_fft_params_3_U0", "Port" : "config_ch_data_V"}]}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.fft_fft_params_U0.fft_syn_fft_params_3_U0", "Parent" : "3",
		...
		"Loop" : []},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_newFuncRoot_proc_proc19_U0", "Parent" : "0",
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Block_newFuncRoot_proc_proc19_U0_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24729", "Max" : "24729"}
	, {"Name" : "Interval", "Min" : "24728", "Max" : "24728"}
]}
