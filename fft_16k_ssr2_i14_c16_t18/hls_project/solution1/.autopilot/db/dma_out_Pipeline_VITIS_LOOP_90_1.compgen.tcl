...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln90 \
    op interface \
    ports { sext_ln90 { I 61 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_joiner_out \
    op interface \
    ports { joiner_out_dout { I 64 vector } joiner_out_num_data_valid { I 3 vector } joiner_out_fifo_cap { I 3 vector } joiner_out_empty_n { I 1 bit } joiner_out_read { O 1 bit } } \
} "
}
