set moduleName fft_syn_fft_params_3
set isTopModule 0
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24727", "Max" : "24727"}
	, {"Name" : "Interval", "Min" : "24727", "Max" : "24727"}
]}
...
set Spec2ImplPortList { 
	...
	config_ch_data_V { ap_fifo {  { config_ch_data_V_dout fifo_data_in 0 16 }  { config_ch_data_V_empty_n fifo_status 0 1 }  { config_ch_data_V_read fifo_port_we 1 1 } } }
}
