...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dout \
    op interface \
    ports { dout_dout { I 64 vector } dout_num_data_valid { I 4 vector } dout_fifo_cap { I 4 vector } dout_empty_n { I 1 bit } dout_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_iter \
    op interface \
    ports { iter_dout { I 18 vector } iter_num_data_valid { I 3 vector } iter_fifo_cap { I 3 vector } iter_empty_n { I 1 bit } iter_read { O 1 bit } } \
} "
}
