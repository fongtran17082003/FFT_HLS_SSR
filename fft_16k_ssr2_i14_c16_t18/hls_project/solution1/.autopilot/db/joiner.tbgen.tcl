...
set C_modelArgMapList {[ 
	{ "Name" : "fft2_out0", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "iter_c", "interface" : "fifo", "bitwidth" : 18, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ iter_c_din sc_out sc_lv 18 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "iter_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "iter_c", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	iter_c { ap_fifo {  { iter_c_din fifo_data_in 1 18 }  { iter_c_num_data_valid fifo_status_num_data_valid 0 3 }  { iter_c_fifo_cap fifo_update 0 3 }  { iter_c_full_n fifo_status 0 1 }  { iter_c_write fifo_port_we 1 1 } } }
}
