...
entity fft_16k_ssr2_i14_c16_t18_top_dma_out is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_16k_ssr2_i14_c16_t18_top_dma_out is 
...
attribute shreg_extract : string;
    ...
    signal iter_5_reg_171 : STD_LOGIC_VECTOR (17 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln90_1_reg_176 : STD_LOGIC_VECTOR (60 downto 0);
    signal empty_fu_141_p3 : STD_LOGIC_VECTOR (29 downto 0);
    signal empty_reg_182 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_fu_163_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_reg_192 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_done : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_idle : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_ready : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_joiner_out_read : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWVALID : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WVALID : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WLAST : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARVALID : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_RREADY : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_BREADY : STD_LOGIC;
    signal grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal sext_ln90_fu_149_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln90_fu_159_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln90_fu_113_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal icmp_ln90_fu_125_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln_fu_117_p3 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    component fft_16k_ssr2_i14_c16_t18_top_dma_out_Pipeline_VITIS_LOOP_90_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        m_axi_gmem2_BID : IN STD_LOGIC_VECTOR (0 downto 0);
        m_axi_gmem2_BUSER : IN STD_LOGIC_VECTOR (0 downto 0);
        tmp : IN STD_LOGIC_VECTOR (30 downto 0);
...
begin
    grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103 : component fft_16k_ssr2_i14_c16_t18_top_dma_out_Pipeline_VITIS_LOOP_90_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start,
        ap_done => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_done,
        ap_idle => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_idle,
        ap_ready => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_ready,
        joiner_out_dout => joiner_out_dout,
        joiner_out_num_data_valid => ap_const_lv3_0,
        joiner_out_fifo_cap => ap_const_lv3_0,
        joiner_out_empty_n => joiner_out_empty_n,
        joiner_out_read => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_joiner_out_read,
        m_axi_gmem2_AWVALID => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWVALID,
        m_axi_gmem2_AWREADY => m_axi_gmem2_AWREADY,
        m_axi_gmem2_AWADDR => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWADDR,
        m_axi_gmem2_AWID => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWID,
        m_axi_gmem2_AWLEN => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLEN,
        m_axi_gmem2_AWSIZE => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWSIZE,
        m_axi_gmem2_AWBURST => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWBURST,
        m_axi_gmem2_AWLOCK => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLOCK,
        m_axi_gmem2_AWCACHE => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWCACHE,
        m_axi_gmem2_AWPROT => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWPROT,
        m_axi_gmem2_AWQOS => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWQOS,
        m_axi_gmem2_AWREGION => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWREGION,
        m_axi_gmem2_AWUSER => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWUSER,
        m_axi_gmem2_WVALID => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WVALID,
        m_axi_gmem2_WREADY => m_axi_gmem2_WREADY,
        m_axi_gmem2_WDATA => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WDATA,
        m_axi_gmem2_WSTRB => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WSTRB,
        m_axi_gmem2_WLAST => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WLAST,
        m_axi_gmem2_WID => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WID,
        m_axi_gmem2_WUSER => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WUSER,
        m_axi_gmem2_ARVALID => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARVALID,
        m_axi_gmem2_ARREADY => ap_const_logic_0,
        m_axi_gmem2_ARADDR => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARADDR,
        m_axi_gmem2_ARID => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARID,
        m_axi_gmem2_ARLEN => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARLEN,
        m_axi_gmem2_ARSIZE => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARSIZE,
        m_axi_gmem2_ARBURST => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARBURST,
        m_axi_gmem2_ARLOCK => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARLOCK,
        m_axi_gmem2_ARCACHE => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARCACHE,
        m_axi_gmem2_ARPROT => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARPROT,
        m_axi_gmem2_ARQOS => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARQOS,
        m_axi_gmem2_ARREGION => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARREGION,
        m_axi_gmem2_ARUSER => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_ARUSER,
        m_axi_gmem2_RVALID => ap_const_logic_0,
        m_axi_gmem2_RREADY => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_RREADY,
        ...
        m_axi_gmem2_BREADY => grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_BREADY,
        m_axi_gmem2_BRESP => m_axi_gmem2_BRESP,
        m_axi_gmem2_BID => m_axi_gmem2_BID,
        m_axi_gmem2_BUSER => m_axi_gmem2_BUSER,
        tmp => tmp_reg_192,
        sext_ln90 => trunc_ln90_1_reg_176);
    ...
    grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_ready = ap_const_logic_1)) then 
                    grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                    empty_reg_182(29 downto 13) <= empty_fu_141_p3(29 downto 13);
                iter_5_reg_171 <= iter_dout;
                trunc_ln90_1_reg_176 <= dout_dout(63 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                    tmp_reg_192(30 downto 13) <= tmp_fu_163_p3(30 downto 13);
            end if;
        end if;
    end process;
    empty_reg_182(12 downto 0) <= "0000000000000";
    tmp_reg_192(12 downto 0) <= "0000000000000";

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem2_AWREADY, m_axi_gmem2_BVALID, ap_CS_fsm_state2, ap_CS_fsm_state72, ap_block_state1, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_done)
    begin
        if ((grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_done = ap_const_logic_0)) then 
    ...
    empty_fu_141_p3 <= 
        trunc_ln_fu_117_p3 when (icmp_ln90_fu_125_p2(0) = '1') else 
        ap_const_lv30_0;
    ...
    grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_ap_start_reg;
    icmp_ln90_fu_125_p2 <= "1" when (signed(iter_dout) > signed(ap_const_lv18_0)) else "0";
    ...
    joiner_out_read_assign_proc : process(grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_joiner_out_read, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            joiner_out_read <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_joiner_out_read;
        else 
            joiner_out_read <= ap_const_logic_0;
        end if; 
    end process;
    ...
    m_axi_gmem2_AWADDR_assign_proc : process(m_axi_gmem2_AWREADY, ap_CS_fsm_state2, ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWADDR, ap_CS_fsm_state4, sext_ln90_fu_149_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem2_AWREADY = ap_const_logic_1))) then 
            m_axi_gmem2_AWADDR <= sext_ln90_fu_149_p1;
    ...
    m_axi_gmem2_AWBURST_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWBURST, ap_CS_fsm_state4)
    begin
    ...
    m_axi_gmem2_AWCACHE_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWCACHE, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWCACHE <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWCACHE;
        else 
    ...
    m_axi_gmem2_AWID_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWID, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWID <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWID;
        else 
    ...
    m_axi_gmem2_AWLEN_assign_proc : process(m_axi_gmem2_AWREADY, ap_CS_fsm_state2, ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLEN, ap_CS_fsm_state4, zext_ln90_fu_159_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem2_AWREADY = ap_const_logic_1))) then 
            m_axi_gmem2_AWLEN <= zext_ln90_fu_159_p1;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWLEN <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLEN;
        else 
    ...
    m_axi_gmem2_AWLOCK_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLOCK, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWLOCK <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWLOCK;
        else 
    ...
    m_axi_gmem2_AWPROT_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWPROT, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWPROT <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWPROT;
        else 
    ...
    m_axi_gmem2_AWQOS_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWQOS, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWQOS <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWQOS;
        else 
    ...
    m_axi_gmem2_AWREGION_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWREGION, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWREGION <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWREGION;
        else 
    ...
    m_axi_gmem2_AWSIZE_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWSIZE, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWSIZE <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWSIZE;
        else 
    ...
    m_axi_gmem2_AWUSER_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWUSER, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_AWUSER <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWUSER;
        else 
    ...
    m_axi_gmem2_AWVALID_assign_proc : process(m_axi_gmem2_AWREADY, ap_CS_fsm_state2, ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_AWVALID, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem2_AWREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem2_BREADY_assign_proc : process(m_axi_gmem2_BVALID, ap_CS_fsm_state72, ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_BREADY, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem2_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem2_WVALID_assign_proc : process(ap_CS_fsm_state3, grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WVALID, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem2_WVALID <= grp_dma_out_Pipeline_VITIS_LOOP_90_1_fu_103_m_axi_gmem2_WVALID;
        else 
        ...
        sext_ln90_fu_149_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln90_1_reg_176),64));

    tmp_fu_163_p3 <= (iter_5_reg_171 & ap_const_lv13_0);
    trunc_ln90_fu_113_p1 <= iter_dout(17 - 1 downto 0);
    trunc_ln_fu_117_p3 <= (trunc_ln90_fu_113_p1 & ap_const_lv13_0);
    zext_ln90_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_182),32));
end behav;
