...
module fft_16k_ssr2_i14_c16_t18_top_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (dout_c_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
endmodule //fft_16k_ssr2_i14_c16_t18_top_entry_proc
