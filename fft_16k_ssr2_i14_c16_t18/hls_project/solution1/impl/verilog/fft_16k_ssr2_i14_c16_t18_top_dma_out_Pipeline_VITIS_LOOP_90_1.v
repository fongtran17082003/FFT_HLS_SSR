...
module fft_16k_ssr2_i14_c16_t18_top_dma_out_Pipeline_VITIS_LOOP_90_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] temp_out_reg_145;
reg    ap_block_pp0_stage0_01001;
reg   [29:0] i_fu_60;
wire   [29:0] add_ln90_fu_112_p2;
wire    ap_loop_init;
reg   [29:0] ap_sig_allocacmp_i_load;
wire   [30:0] zext_ln90_fu_102_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln90_fu_106_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln90_fu_106_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln90_fu_112_p2 = (ap_sig_allocacmp_i_load + 30'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (joiner_out_empty_n == 1'b0);
end
...
assign icmp_ln90_fu_106_p2 = (($signed(zext_ln90_fu_102_p1) < $signed(tmp)) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = temp_out_reg_145;
...
assign zext_ln90_fu_102_p1 = ap_sig_allocacmp_i_load;

endmodule //fft_16k_ssr2_i14_c16_t18_top_dma_out_Pipeline_VITIS_LOOP_90_1
