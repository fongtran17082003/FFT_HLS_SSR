...
module fft_16k_ssr2_i14_c16_t18_top_dma_in_Pipeline_VITIS_LOOP_61_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [13:0] tmp_i_reg_210;
reg   [13:0] tmp_i_58_reg_215;
reg   [13:0] tmp_1_i_reg_220;
wire   [13:0] trunc_ln72_fu_173_p1;
reg   [13:0] trunc_ln72_reg_225;
reg   [29:0] i_fu_76;
wire   [29:0] add_ln61_fu_126_p2;
wire    ap_loop_init;
reg   [29:0] ap_sig_allocacmp_i_load;
reg    ap_block_pp0_stage0_01001;
wire   [30:0] zext_ln61_fu_116_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln61_fu_120_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_1_i_reg_220 <= {{m_axi_gmem1_RDATA[27:14]}};
        tmp_i_58_reg_215 <= {{m_axi_gmem1_RDATA[41:28]}};
        tmp_i_reg_210 <= {{m_axi_gmem1_RDATA[55:42]}};
        trunc_ln72_reg_225 <= trunc_ln72_fu_173_p1;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln61_fu_120_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln61_fu_126_p2 = (ap_sig_allocacmp_i_load + 30'd1);
...
assign icmp_ln61_fu_120_p2 = (($signed(zext_ln61_fu_116_p1) < $signed(tmp_4)) ? 1'b1 : 1'b0);

assign input_stream_din = {{{{{{{{tmp_i_reg_210}, {2'd0}}, {tmp_i_58_reg_215}}, {2'd0}}, {tmp_1_i_reg_220}}, {2'd0}}, {trunc_ln72_reg_225}}, {2'd0}};
...
assign trunc_ln72_fu_173_p1 = m_axi_gmem1_RDATA[13:0];

assign zext_ln61_fu_116_p1 = ap_sig_allocacmp_i_load;

endmodule //fft_16k_ssr2_i14_c16_t18_top_dma_in_Pipeline_VITIS_LOOP_61_1
