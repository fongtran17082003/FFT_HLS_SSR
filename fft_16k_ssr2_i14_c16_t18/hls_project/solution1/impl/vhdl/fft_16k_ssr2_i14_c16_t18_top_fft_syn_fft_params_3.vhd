...
entity fft_16k_ssr2_i14_c16_t18_top_fft_syn_fft_params_3 is
    generic (
...
architecture arch of fft_16k_ssr2_i14_c16_t18_top_fft_syn_fft_params_3 is
    --------------------- Component ---------------------
    component fft_16k_ssr2_i14_c16_t18_top_fft_syn_fft_params_3_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fft_16k_ssr2_i14_c16_t18_top_fft_syn_fft_params_3_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
