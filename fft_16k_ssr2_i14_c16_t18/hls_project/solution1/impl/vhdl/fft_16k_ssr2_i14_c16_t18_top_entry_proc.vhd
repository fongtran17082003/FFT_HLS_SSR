...
entity fft_16k_ssr2_i14_c16_t18_top_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_16k_ssr2_i14_c16_t18_top_entry_proc is 
...
begin
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, dout_c_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (dout_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    dout_c_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, dout_c_full_n)
    begin
